...
# gem "pg_query", ">= 0.9.0" # Allows PGHero to analyze queries - temporarily commented out due to compilation issues
gem "pg_search", "~> 2.3.6" # PgSearch builds Active Record named scopes that take advantage of PostgreSQL's full text search
# gem "pghero", "~> 3.6" # Dashboard for Postgres - temporarily commented out due to pg_query dependency
